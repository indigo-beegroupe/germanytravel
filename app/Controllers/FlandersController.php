...
use Symfony\Component\DomCrawler\Crawler;
    ...
    function getRegion($pc)
    {
        ...
        else if ($pc >= 1300 && $pc <= 1499) {
            return 'Walloon Brabant';
        }
        else if ($pc >= 1500 && $pc <= 1999) {
            return 'Flemish Brabant';
        }
        else if ($pc >= 3000 && $pc <= 3499) {
            return 'Flemish Brabant';
        }
        else if ($pc >= 2000 && $pc <= 2999) {
            return 'Antwerp';
        }
        else if ($pc >= 3500 && $pc <= 3999) {
            return 'Limburg';
        }
        ...
        else if ($pc >= 6000 && $pc <= 6599) {
            return 'Hainaut';
        }
        else if ($pc >= 7000 && $pc <= 7999) {
            return 'Hainaut';
        }
        else if ($pc >= 6600 && $pc <= 6999) {
            return 'Luxembourg';
        }
        else if ($pc >= 8000 && $pc <= 8999) {
            return 'West Flanders';
        }
        else if ($pc >= 9000 && $pc <= 9999) {
...
class FlandersController extends Controller
{


    public function flandersConcerts(Request $request, Response $response)
    {
    	// delete all events beginning with 'conc_'
            $delete_conc = "DELETE FROM `agenda.brussels_bxl` WHERE `id_event` LIKE 'f_conc_%'";
        ...
        foreach (range(1, 2) as $x) {
            ...
            $concert_urls = [
                "https://agenda.brussels/api/en/listEvents/concerts/pop-rock?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/concerts/chanson?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/concerts/jazz-blues?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/concerts/worldmusic?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/concerts/electro-dj?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/concerts/classical-music?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/concerts/contemporary-music?page=".$x."&place_region=flandre"
            ];
    ...
    public function flandersShows(Request $request, Response $response)
    {
    	// delete all events beginning with 'w_show_'
            $delete_shows = "DELETE FROM `agenda.brussels_bxl` WHERE `id_event` LIKE 'f_show_%'";
            ...
            $show_urls = [
                "https://agenda.brussels/api/en/listEvents/spectacles/dance?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/spectacles/opera-and-operetta?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/spectacles/musical-comedy?page=".$x."&place_region=flandre"
            ];
    ...
    public function flandersExpo(Request $request, Response $response)
    {
    	// delete all events beginning with 'expo_'
            $delete_expo = "DELETE FROM `agenda.brussels_bxl` WHERE `id_event` LIKE 'f_expo_%'";
        ...
        foreach (range(1, 2) as $x) {
            ...
            $expo_urls = [
                "https://agenda.brussels/api/en/listEvents/exhibitions/museums-and-art-ce?page=".$x."&place_region=flandre",
                //"https://agenda.brussels/api/en/listEvents/exhibitions/art-galleries?page=1&place_region=flandre",
                //"https://agenda.brussels/api/en/listEvents/highlights/starting-exhibition?page=1&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/highlights/finishing-exhibitio?page=".$x."&place_region=flandre"
            ];
    ...
    public function flandersTheater(Request $request, Response $response)
    {
    	// delete all events beginning with 'thea_'
            $delete_thea = "DELETE FROM `agenda.brussels_bxl` WHERE `id_event` LIKE 'f_thea_%'";
        ...
        foreach (range(1, 2) as $x) {
            ...
            $theater_urls = [
                "https://agenda.brussels/api/en/listEvents/theatre/theater?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/theatre/musical-theatre?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/theatre/tales?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/theatre/humour?page=".$x."&place_region=flandre",
                "https://agenda.brussels/api/en/listEvents/theatre/puppet-show?page=".$x."&place_region=flandre",
    ...
    public function flandersCinema(Request $request, Response $response)
    {
        // delete all events beginning with 'show_'
            $delete_cine = "DELETE FROM `agenda.brussels_bxl` WHERE `id_event` LIKE 'f_cine_%'";
        ...
        foreach (range(1, 2) as $x) {
            ...
            $theater_urls = [
                "https://agenda.brussels/api/en/listEvents/cinema/cine-club?page=".$x."&place_region=flandre"  
            ];
