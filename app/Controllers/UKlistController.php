...
class UKlistController extends Controller
{
...
// public $url_root = "https://www.sortiraparis.com/";
    public function concerts(Request $request, Response $response)
        ...
        $event = array (
                        ...
                        "street_complete" => 'div.addressCard div.adr',
            ...
            $db_id = "uklist_conc_";
            $event_links = 'div.eventDetails ul li.title a';//div a h2.head';
            $url = array (
                "https://www.list.co.uk/events/music/sort:date/"
                  ...
                  /* foreach (range(1, 2) as $x) */ {
                     ...
                     foreach( $links as $link_member) {
                            ...
                            //     // $article = explode( 'cliquez ici', $article, 2)[0]; 
                               ...
                               //price 
                              $event_price/* _blk */ = $crawler->filter($event["event_price"]) -> extract("_text");
